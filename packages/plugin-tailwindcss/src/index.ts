  ...
  return {
    ...
    afterCommandOfGenerateAlias: () => ({
      ...
      prettierConfig: {
        ...
        plugins: [
          `${getAbsolutePath('prettier-plugin-tailwindcss')}/dist/index.mjs`,
          `${getAbsolutePath('prettier-plugin-classnames')}/dist/index.js`,
          `${getAbsolutePath('prettier-plugin-merge')}/dist/index.js`,
        ],
      },
    }),
  };
