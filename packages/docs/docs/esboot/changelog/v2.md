...
- feat: add [eslint-plugin-esboot](/docs/esboot/eslint/rules)。
...
- feat: add [getImportPluginsOfRsuite](/docs/api/helpers#getimportpluginsofrsuite)。

### v2.14.2

`2024-06-06`

- feat: support [useLangJsonPicker](/docs/esboot/guides/dev#uselangjsonpicker)。
...
- feat: support [mfsuOptions](/docs/esboot/guides/config#mfsuoptions)
